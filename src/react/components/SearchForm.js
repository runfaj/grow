...
export default class SearchForm extends Component {
    constructor(props) {
        ...
        this.types = [{'value': 'representative', 'label': 'Representative'},{'value': 'senator', 'label': 'Senator'}];
        ...
        this.state = {
            ...
            selectedState: this.states[0].abbreviation,
        };
    }
    ...
    onSubmit() {
        if(this.props.onSubmit)
            this.props.onSubmit(this.state.selectedType, this.state.selectedState);
    }
            ...
            <div className="SearchForm">
                ...
                >
                    {this.states.map((state,i)=>(
                        ...
                        >{state.name} ({state.abbreviation})</option>
                    ))}
                </select>
